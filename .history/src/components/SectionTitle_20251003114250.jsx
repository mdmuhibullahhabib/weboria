  ...
  return (
    <div className="text-center my-10 px-4">
      <div className="text-5xl md:text-3xl lg:text-4xl font-bold tracking-wide leading-snug">
        ...
        <h2 className="text-6xl lg:font-extrabold text-blue-600 text-center">{titleTop}</h2>
        <h2 className='text-orange-500 font-semibold text-6xl lg:ml-[400px]'> {titleBottom}</h2>
      </div>
    </div>
  );
}
