    ...
    <div className="font-sans bg-gray-50 min-h-screen">
      ...
      <section className="container mx-auto px-4 py-16 lg:py-24">
        <header className="text-center mb-12">
          <h2 className="text-xl font-bold text-gray-500 uppercase tracking-widest">VISUAL I PROVIDES</h2>
          <p className="text-4xl md:text-5xl font-extrabold text-gray-900 mt-2">360° DIGITAL SOLUTIONS</p>
        </header>
