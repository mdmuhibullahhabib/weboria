...
const TestimonialSection = () => {
  ...
  return (
    <section className="relative w-full md:py-4 py-3 bg-gradient-to-r from-white via-gray-50 to-orange-50 font-['Inter'] overflow-hidden">
...
const StatsSection = () => (
  <section className="relative lg:py-8 py-6 bg-gradient-to-br from-white via-gray-50 to-orange-50 font-['Inter'] overflow-hidden">
    ...
    <div className="md:py-6 py-3 max-w-7xl mx-auto px-6 text-center">
      {/* Header */}
      <motion.div
