        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mt-16">
          ...
          <div className="flex flex-col p-4">
            ...
            <div className="relative w-full h-96 rounded-lg shadow-xl overflow-hidden bg-gray-100 flex items-center justify-center">
              ...
              <Image
                src={aloron} // ✅ লোকাল ইমেজ
                alt="Aloron Project Mockup"
                fill // ✅ ইমেজ পুরো div কভার করবে
                className="object-cover hover:scale-105 transition-transform duration-500" // ✅ সুন্দর hover ইফেক্ট
                priority // ✅ প্রাথমিক লোডের জন্য দ্রুত
              />
            </div>
          </div>
