...
<div className="max-w-5xl mx-auto px-4 py-10">
  ...
  <p className="text-base md:text-lg text-gray-700 leading-relaxed">
    At <span className="font-semibold text-black">Weboria</span>, strong communication builds strong partnerships.
    ...
    <span className="font-medium text-black"> SEO</span>, 
    <span className="font-medium text-black"> Web Development</span>, 
    <span className="font-medium text-black"> Cyber Security</span>, and 
    <span className="font-medium text-black"> AI-driven strategies</span> 
