...
export default function ContactPage() {
  ...
  const contactInfo = [
    { icon: Mail, title: "Email", details: "weboria.tech@gmail.com", description: "Send us an email anytime" },
    { icon: Phone, title: "Phone", details: "+880 1577118273", description: "Sat-Sun from 8am to 10pm" },
    { icon: MapPin, title: "Office", details: "Dhaka, Bangladesh", description: "Mirpur 1200" },
  ...
  return (
    <>
      <title>Contact - Weboria</title>

      <div className="min-h-screen bg-white pt-6 overflow-hidden">
        {/* Hero Section */}
        <section className="w-full bg-white text-gray-900 py-2">
          ...
          >
            ...
            >
              <div className="w-full h-1 bg-gradient-to-r from-orange-500 to-pink-500 rounded-full"></div>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-700 text-lg leading-relaxed">
              ...
              <span className="font-semibold text-black"> AI-driven strategies</span> can transform your growth journey.
            </p>
        ...
        <section className="lg:py-12 py-8 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <motion.div
              ...
              variants={fadeUp}
              custom={0.2}
              className="card shadow-md border border-gray-200 rounded-2xl bg-white hover:shadow-xl transition-all"
            >
            ...
            >
              <motion.div
                variants={fadeUp}
                custom={0.1}
                className="border border-gray-200 rounded-2xl shadow-md bg-white p-8 hover:shadow-xl transition-shadow"
              >
              ...
              >
                {contactInfo.map((item, index) => (
                  <motion.div
                    ...
                    className="border border-gray-200 bg-white shadow-sm rounded-xl p-6 transition-all duration-300"
                  >
