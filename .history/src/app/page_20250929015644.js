...
export default function Home() {
  const services = [
    ...
    },
    {
      ...
      description:
        "Comprehensive digital marketing strategies that increase brand visibility and drive targeted traffic to your business.",
    ...
    },
    {
      ...
      title: "SEO Services",
      description:
        "Search engine optimization that improves your website's visibility and drives organic traffic from your target audience.",
  ...
  const testimonials = [
    {
      ...
      role: "CEO",
      content:
        "Weboria transformed our outdated website into a modern, high-performing platform that increased our conversions by 40%. Their attention to detail and technical expertise is unmatched.",
      rating: 5,
    },
    {
      name: "Michael Chen",
      ...
      role: "Founder",
      content:
        "The mobile app they developed exceeded our expectations. The user experience is incredible and our customer engagement has tripled since launch.",
      rating: 5,
    },
    {
      ...
      role: "Owner",
      content:
        "Their digital marketing strategy helped us reach new customers and increase our online orders by 60%. Outstanding results and professional service.",
      rating: 5,
    },
  ];
      ...
      <section id="services" className="py-24 bg-base-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-12">
            <Link href="/services">
              <button className="btn btn-outline btn-lg flex items-center mx-auto">
                View All Services
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <TestimonialC key={index} {...testimonial} />
            ))}
          </div>
        </div>
      </section>
