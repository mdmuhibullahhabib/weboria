...
export default function Service() {
  ...
  const HeroSection = () => {
    // Styles for the background effect from Screenshot 104
    const backgroundStyle = {
      backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), 
                        url('https://placehold.co/1200x800/1e293b/0f7e4b?text=SOFTWARE+BACKGROUND')`,
      backgroundSize: 'cover',
      backgroundPosition: 'center',
    };

    return (
      <div style={backgroundStyle} className="relative pt-24 pb-12 md:pt-32 md:pb-20 text-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Title mimicking Screenshot 113 Hero */}
          <h1 className="text-6xl md:text-8xl font-extrabold leading-tight tracking-tighter mb-16">
