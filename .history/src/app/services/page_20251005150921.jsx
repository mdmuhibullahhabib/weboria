...
const HeroSection = () => {
  ...
  const ServiceListItem = ({ text }) => (
    <div className="flex items-start mb-3 hover:translate-x-1 transition-transform duration-300">
      <span
        className="text-2xl font-bold mr-3 mt-1 flex-shrink-0"
        style={{ color: '#f97316' }}
      >
        +
      </span>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          <div>
            ...
            <p className="text-lg text-gray-600 max-w-lg mt-6">
              Empower your business with high-performance software solutions.
              From web applications to enterprise systems, we create scalable,
              efficient, and tailored digital products.
            </p>
          </div>
