...
export default function Service() {
  ...
  const whyChooseKeywords = [
    { title: 'EXPERIENCE...', customColor: '#1f2937' }, // Dark gray/black
    { title: 'COLLABORATIVE...', customColor: '#f97316' }, // Orange/Amber
    { title: 'EFFECTIVENESS...', customColor: '#f97316' }, // Orange/Amber
    { title: 'CLIENT-CENTRIC...', customColor: '#f97316' }, // Orange/Amber
  ];
...
const WorkingProcessSection = () => {
  const processSteps = [
    ...
    { number: '02', title: 'DESIGN & ARCHITECTURE' },
    { number: '03', title: 'DEPLOYMENT & TESTING' },
    { number: '04', title: 'POST-DEPLOYMENT SUPPORT & MAINTENANCE' },
  ];
  ...
  return (
    <div className="relative py-24">
      ...
      <div className="absolute inset-0 -z-10">
        <Image
          src="/images/working-bg.jpg" // public/images/working-bg.jpg
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <h2 className="text-6xl md:text-8xl font-extrabold mb-16 text-orange-500">
          WORKING PROCESS
        </h2>
        ...
        <div className="relative h-[600px] md:h-[800px] flex items-center justify-center">
          ...
          {/* Background Lines */}
          <div className="absolute top-0 left-1/4 h-[50%] w-0 border-l-2 border-dashed border-gray-400"></div>
          <div className="absolute h-0 w-[50%] border-t-2 border-dashed border-gray-400" style={{ top: '40%', left: '25%' }}></div>
          <div className="absolute top-0 right-1/4 h-[50%] w-0 border-r-2 border-dashed border-gray-400"></div>

          {/* Step Boxes */}
          <div className="absolute" style={{ top: '5%', left: '25%', transform: 'translateX(-50%)' }}>
            <StepBox step={processSteps[0]} />
          </div>
          <div className="absolute" style={{ top: '35%', left: '5%' }}>
