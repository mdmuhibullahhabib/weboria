...

{
  ...
  "serviceListSection": {
    "heading": "Best Software Development Service in Dhaka, Bangladesh",
    "description": "In today's digital landscape, powerful, scalable software is a must for business success. As a leading Software Development Company in Dhaka, Bangladesh, Visual I specializes in crafting custom software solutions that drive growth. From web applications to enterprise software and AI-driven solutions, our expert developers ensure seamless functionality, robust security, and innovative designs. We deliver high-performance, user-focused software that keeps your business ahead of the competition. Let us turn your vision into reality with cutting-edge technology tailored to your needs.",
    "subHeading": "HOW SOFTWARE DEVELOPMENT EMPOWERS YOUR BUSINESS?",
    "subDescription": "Custom software solutions streamline operations, enhance efficiency, and improve customer experiences. Tailored systems automate tasks, save time, and reduce costs, allowing your business to scale faster and make data-driven decisions. With the right software, you gain a competitive edge, boosting productivity and ultimately securing a higher return on investment (ROI).",
    "images": [
      "https://placehold.co/600x400/f2f2f2/1f2937?text=Collaborative+Development+Team",
      "https://placehold.co/300x200/f2f2f2/1f2937?text=Dedicated+Programmer",
      "https://placehold.co/300x200/f2f2f2/1f2937?text=Dedicated+Programmer"
    ]
  },
  "whyChooseUs": {
    ...
    "contentCard": {
      ...
      "description": "Our seasoned software developers have extensive knowledge and experience in various domains, including web development, mobile app development, and custom software solutions.",
