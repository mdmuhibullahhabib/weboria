...
<section className="relative py-10 px-6 lg:px-20 overflow-hidden">
  ...
  <div className="hidden lg:block absolute top-10 left-0 w-full h-full pointer-events-none">
    <h1 className="text-[clamp(8rem,20vw,14rem)] font-black leading-none uppercase text-gray-200 opacity-20 whitespace-nowrap -translate-x-10">
      WEBORIA
    </h1>
  </div>

  {/* Content */}
  <div className="relative z-10 flex flex-col lg:flex-row items-start justify-between gap-10 lg:gap-20">
    {/* Left Column */}
    <div className="lg:w-1/2 flex flex-col justify-center">
      <div className="uppercase flex flex-col lg:flex-row flex-wrap items-start lg:items-center gap-4 lg:gap-3">
        <span className="text-[clamp(2.5rem,6vw,4rem)] md:text-[clamp(3rem,6vw,6rem)] font-serif font-extrabold text-black leading-tight">
          AI-Powered
        </span>
        <span className="text-[clamp(2.8rem,7vw,5rem)] md:text-[clamp(3.5rem,7vw,6rem)] font-serif font-extrabold text-orange-500 whitespace-nowrap">
    ...
    <div className="lg:w-1/2 max-w-lg lg:pt-16">
      {/* About / Hero image or content goes here */}
    </div>
  </div>
</section>
