...
import hero from "../../public/assets/images/home/free-seo-audit-by-best-search-engine-optimization-company-in-bangladesh.webp"
...
const Home = () => {
  return (
    <div className="min-h-screen bg-white text-gray-800 antialiased">
      {/* 1. Hero Section */}
  <section className="relative overflow-hidden bg-gradient-to-br from-white via-gray-50 to-orange-50 py-24 px-6 lg:px-20">
      {/* Background Text */}
      <div className="hidden lg:block absolute top-16 left-1/2 -translate-x-1/2 opacity-10 pointer-events-none">
        <h1 className="text-[12rem] xl:text-[14rem] font-extrabold tracking-widest text-gray-200 uppercase">
          Weboria
        </h1>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center justify-between gap-16">
        ...
        <div className="lg:w-1/2 space-y-8 text-center lg:text-left">
          ...
          >
            We craft intelligent digital experiences through creative design, 
            next-gen technology, and strategic innovation — empowering businesses 
            to grow, adapt, and dominate in the digital world.
          </motion.p>
        ...
        >
          <div className="relative">
            <div className="absolute -inset-6 bg-gradient-to-tr from-orange-200 to-pink-200 rounded-full blur-3xl opacity-50 animate-pulse"></div>
            <Image
              // src={HeroImg}
              // src={HeroImg}
              alt="Weboria Hero"
              className="relative w-full max-w-md lg:max-w-lg drop-shadow-2xl rounded-3xl"
              priority
            />
          </div>
        </motion.div>
