...
const Home = () => {
  return (
    ...
    <section className="py-6 px-4 lg:px-20 bg-gray-50 overflow-hidden">
      <div className="flex flex-col lg:flex-row items-center justify-between">
        {/* Left side - Experience */}
        <motion.div
          className="lg:w-1/3 mb-10 lg:mb-0 pr-8"
        ...
        >
          <motion.p
            className="text-8xl md:text-9xl font-extrabold text-orange-500 leading-none"
          ...
          <p className="text-xl mt-6 font-light text-gray-600 border-t pt-4 border-gray-300">
            Empowering brands with smart digital solutions that spark growth,
            boost visibility, and deliver measurable success — crafted by
            WebOria.
          </p>
        </motion.div>
        ...
        <motion.div
          className="lg:w-2/3 grid grid-cols-1 sm:grid-cols-2 gap-8 p-4"
          ...
          {[
            {
              ...
              desc: "At WebOria, we blend creativity and data to craft strategies that maximize ROI. Every campaign is built to attract, engage, and convert.",
              subTitle: "Measurable Impact",
              subDesc:
                "From traffic to revenue, we track every metric that matters — helping you see real growth, not just numbers.",
            },
            {
              title: "Stunning Responsive Design",
              desc: "Your digital presence deserves perfection on every device. WebOria builds responsive, fast, and visually striking designs that connect instantly.",
              subTitle: "Creative Excellence",
              subDesc:
                "Our designers turn ideas into digital art — creating interfaces that inspire trust, drive emotion, and boost brand recognition.",
            },
            {
              title: "Security & Reliability",
              desc: "WebOria protects your brand with enterprise-grade data security and 24/7 monitoring — so your business runs safely and smoothly.",
              subTitle: "Sustainable Business Growth",
              subDesc:
                "Through digital strategy, SEO, and modern tech, we help your business rise above competition and stay ahead of the curve.",
            },
          ].map((card, index) => (
            <motion.div
              key={index}
              className="border border-orange-300 p-6 rounded-lg bg-white shadow-sm hover:shadow-lg transition-all"
            ...
            >
              ...
              <div className="border-t border-orange-300 pt-4">
                ...
                <p className="text-gray-600 text-sm">{card.subDesc}</p>
              </div>
            </motion.div>
          ))}
        </motion.div>
