...
// Updated import based on the component path provided
...
              </p>
            </div>
            {/* Adjusted PRESENCE text to match the black background block style in the screenshot */}
            <p className="text-7xl md:text-9xl font-serif font-extrabold text-black leading-tight bg-black text-white p-1 inline-block -translate-x-1">
              PRESENCE
            </p>
          </div>
