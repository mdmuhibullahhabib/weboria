                ...
                <p className="text-gray-700 text-base md:text-lg lg:text-xl
                 leading-relaxed md:leading-7 lg:leading-8 max-w-4xl mx-auto">
                    ...
                    Each project reflects our commitment to innovation, performance,
                     and client success. Explore how our tailored solutions help brands grow,
                      engage audiences, and stay ahead in today’s fast-evolving digital world. Ready to elevate your business? Let’s create something <span className="font-semibold text-blue-600">exceptional</span> together.
                </p>
            </div>
        </section>
    );
