...
const FeaturedProjects = () => {
    return (
        <section className="w-full bg-white py-4 px-4 md:px-20">
            {/* Small heading */}
            <p className="text-lg text-black font-extrabold uppercase tracking-widest mb-6 flex items-center">
                FRAME WORK FOR SUCCESS
                <span className="ml-2 w-3 h-3 bg-black rounded-full"></span>
            </p>

            {/* Main content */}
            <div className="flex flex-col md:flex-row items-center mb-4 gap-8 md:gap-12">
                {/* Image */}
