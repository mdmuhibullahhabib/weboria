    ...
    >
      <div className="max-w-6xl mx-auto px-6 text-center">
        <h1 className="text-5xl md:text-7xl font-extrabold mb-6 leading-tight">
          Empowering Brands with <br /> Impactful Software Solutions
        </h1>
        <p className="text-xl text-gray-200 max-w-3xl mx-auto">
          From planning to deployment, we deliver tailored digital products that
          transform your business for the modern age.
        </p>
      </div>
    </section>
  );
    ...
    <section className="bg-gray-50 py-24">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <p className="text-lg text-gray-600 mb-12 max-w-4xl">
          We specialize in high-performance web, mobile, and enterprise
          software. Our expert team ensures robust, scalable solutions designed
      ...
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12">
        <div>
          ...
          <p className="text-lg text-gray-600 mb-8">
            Let's discuss your next big idea. Contact us today for a free
            consultation.
          </p>
        ...
        <form className="space-y-4">
          ...
          <button
            type="submit"
            className="btn bg-gray-900 text-white hover:bg-orange-500 w-full py-3 rounded-lg font-semibold"
          >
